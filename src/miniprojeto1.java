...
public class miniprojeto1 {
    ...
    public static void main(String[] args){
        ...
        Capitulo capituloRaiz = new Capitulo("Prefacio", "Ola, " + protagonista.getNome() + " seja bem vindo ao Livro interativo! \n" +
        ...
        Capitulo capitulo1 = new Capitulo("Capitulo 1",protagonista.getNome() + ", voce está em um bar a noite, onde estão todos muito animados bebendo e cantando. \n"+
        ...
        // Execução dos capitulos
        capituloRaiz.setEscolhas(escolhasRaiz);
        capitulo1.setEscolhas(escolhas1);
        capitulo21.setEscolhas(escolhas21);
        capitulo2.setEscolhas(escolhas2);
        capitulo3.setEscolhas(escolhas3);
